...
import com.poo2.tableModel.RelatorioVendaTableModel;
...
public class RelatorioVendas extends JFrame {
	...
	private void PreencherTabela(long id) {
		...
		RelatorioVendaTableModel ptm = new RelatorioVendaTableModel(pd.listar("idEmpresaVenda", id));
		table.setModel(ptm);
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RelatorioVendas frame = new RelatorioVendas(Longg);
	 ...
	 * Create the frame.
	 */
	public RelatorioVendas(long id) {
